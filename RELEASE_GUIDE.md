...
- **MAJOR** — breaking changes to the public API (`utac_logistic`,
  `beta_fit`, `frame_principle`, `v_rig`, CLI commands).
...
`utac-core`'s `[stack]` extra pins other `GenesisAeon/*` packages with `>=`
